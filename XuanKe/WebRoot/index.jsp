...
<h2>选课管理信息系统</h2>
	  ...
	  <h3>邮箱：${Email}</h3>
	  <h3>状态：${Status}</h3>
	  <h3><a href="UpStuServlet?Snum=${Snum} ">修改信息</a></h3>
	  <h3><a href="SelectServlet?Snum=${Snum} ">课程</a></h3> --%>
                                    <tr>
                                        <th class="center">学号:</th>
                                        <th class="center">姓名:</th>
                                        <th class="center">性别：</th>
                                        <th class="center">出生年月：</th>
                                        <th class="center">班级号：</th>
                                    ...
                                    <tr class="odd gradeX">
                                            ...
                                            <td class="center">${Snum}</td>
                                            <td class="center">${Sname}</td>
                                            <td class="center">${Ssex} </td>
                                            <td class="center">${Sbirth}</td>
                                            <td class="center">${Clnum} </td>
                                            <td class="center">${Email}</td>
                                            <td class="center">${Status}</td>
                                            <td class="center"><a href="UpStuServlet?Snum=${Snum} ">修改信息</a></td>
