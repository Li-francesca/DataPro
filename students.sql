...
CREATE TABLE `course` (
  ...
  PRIMARY KEY (`Cnum`),
  KEY `academy` (`academy`),
  CONSTRAINT `course_ibfk_1` FOREIGN KEY (`academy`) REFERENCES `academy` (`Anum`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `stucourse` (
  ...
  KEY `2` (`Cnum`),
  KEY `Tnum` (`Tnum`),
  CONSTRAINT `stucourse_ibfk_1` FOREIGN KEY (`Snum`) REFERENCES `student` (`Snum`) ON DELETE SET NULL ON UPDATE NO ACTION,
  CONSTRAINT `stucourse_ibfk_2` FOREIGN KEY (`Cnum`) REFERENCES `course` (`Cnum`) ON DELETE SET NULL ON UPDATE NO ACTION,
  CONSTRAINT `stucourse_ibfk_3` FOREIGN KEY (`Tnum`) REFERENCES `teacher` (`Tnum`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('2016012016', 'litj', '女', '2018-01-07 12:03:01', null, '1103416066@qq.com', '2016', '大二');
